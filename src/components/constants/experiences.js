...
export const siemens = [
  { id: 0, value: 'Maintained and provided support for the various applications through tools, SQL statements (Ingres DB), and Perl scripts.' },
  { id: 1, value: 'Developed and maintained a new team website using Vue.js.' },
  { id: 2, value: 'Contributed to the development and maintenance of a new internal web application using Vue.js for the frontend and Java Spring/Java Persistence for the backend API.' },
  { id: 3, value: 'Led the intern team while also streamlining the onboarding process for new interns.' },
  { id: 4, value: 'Filmed, recorded audio, and edited various videos highlighting my team’s responsibilities and accomplishments.' }
];
